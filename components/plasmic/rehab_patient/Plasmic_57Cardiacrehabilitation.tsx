...
import sty from "./Plasmic_57Cardiacrehabilitation.module.css"; // plasmic-import: IomJSDy0xeaB/css
...
function Plasmic_57Cardiacrehabilitation__RenderFunc(props: {
  ...
  return (
    <React.Fragment>
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox___8NlJc)}>
          <div
            className={classNames(
              projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__iFfjs)}>
            <PlasmicImg__
        ...
        <div className={classNames(projectcss.all, sty.freeBox__wioAg)}>
          <Video
        ...
        <div className={classNames(projectcss.all, sty.freeBox__rxzUe)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox___1Ns1F)}
            onClick={async event => {
              const $steps = {};
