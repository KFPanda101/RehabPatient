...
import sty from "./Plasmic_33PreventingFallsAndFallingFromTheBed.module.css"; // plasmic-import: 0y3S2cDJoF53/css
...
function Plasmic_33PreventingFallsAndFallingFromTheBed__RenderFunc(props: {
  ...
  return (
    <React.Fragment>
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__g5EwK)}>
          <div
            className={classNames(
              projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__d7E4H)}>
            <PlasmicImg__
        ...
        <div className={classNames(projectcss.all, sty.freeBox___89OG)}>
          <Video
        ...
        <div className={classNames(projectcss.all, sty.freeBox__tHFf4)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___0ZGAv)}
          onClick={async event => {
            const $steps = {};
