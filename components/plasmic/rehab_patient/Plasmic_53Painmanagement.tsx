...
import sty from "./Plasmic_53Painmanagement.module.css"; // plasmic-import: 3uLftkNYP6A1/css
...
function Plasmic_53Painmanagement__RenderFunc(props: {
  ...
  return (
    <React.Fragment>
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__mrtjN)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__wGSvG)}>
          <Video
        ...
        <div className={classNames(projectcss.all, sty.freeBox__gM3Fc)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__ok82N)}
            onClick={async event => {
              const $steps = {};
