...
import sty from "./Plasmic_45Minerals.module.css"; // plasmic-import: 1kZkZqOVjhEp/css
...
function Plasmic_45Minerals__RenderFunc(props: {
  ...
  return (
    <React.Fragment>
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__zIobQ)}>
          <div
            className={classNames(
              projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__zLmqp)}>
            <PlasmicImg__
        ...
        <div className={classNames(projectcss.all, sty.freeBox__xdOrD)}>
          <Video
        ...
        <div className={classNames(projectcss.all, sty.freeBox__bvIxI)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__gQf4B)}
            onClick={async event => {
              const $steps = {};
