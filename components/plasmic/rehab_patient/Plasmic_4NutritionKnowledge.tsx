          ...
          <div
            ...
            onClick={async event => {
              ...
              $steps["goTo41Carbohydrate"] = true
                ? (() => {
                    const actionArgs = { destination: `/4-1Carbohydrate` };
                    return (({ destination }) => {
                      if (
                        typeof destination === "string" &&
                        destination.startsWith("#")
          ...
          <div
            ...
            onClick={async event => {
              ...
              $steps["goTo42Vitamin"] = true
                ? (() => {
                    const actionArgs = { destination: `/4-2Vitamin` };
                    return (({ destination }) => {
                      if (
                        typeof destination === "string" &&
                        destination.startsWith("#")
          ...
          <div
            ...
            onClick={async event => {
              ...
              $steps["goTo43Protein"] = true
                ? (() => {
                    const actionArgs = { destination: `/4-3Protein` };
                    return (({ destination }) => {
                      if (
                        typeof destination === "string" &&
                        destination.startsWith("#")
          ...
          <div
            ...
            onClick={async event => {
              ...
              $steps["goTo44Fat"] = true
                ? (() => {
                    const actionArgs = { destination: `/4-4Fat` };
                    return (({ destination }) => {
                      if (
                        typeof destination === "string" &&
                        destination.startsWith("#")
          ...
          <div
            ...
            onClick={async event => {
              ...
              $steps["goTo45Minerals"] = true
                ? (() => {
                    const actionArgs = { destination: `/4-5Minerals` };
                    return (({ destination }) => {
                      if (
                        typeof destination === "string" &&
                        destination.startsWith("#")
          ...
          <div
            ...
            onClick={async event => {
              ...
              $steps["goTo46VariousTypesOfFood"] = true
                ? (() => {
                    const actionArgs = {
                      destination: `/4-6Various types of food`
                    };
                    return (({ destination }) => {
                      if (
                        typeof destination === "string" &&
          ...
          <div
            ...
            onClick={async event => {
              ...
              $steps["goTo47ChooseFood"] = true
                ? (() => {
                    const actionArgs = { destination: `/4-7Choose food` };
                    return (({ destination }) => {
                      if (
                        typeof destination === "string" &&
                        destination.startsWith("#")
          ...
          <div
            ...
            onClick={async event => {
              ...
              $steps["goTo48BalancedDietaryGuidelines"] = true
                ? (() => {
                    const actionArgs = {
                      destination: `/4-8Balanced Dietary Guidelines`
                    };
                    return (({ destination }) => {
                      if (
                        typeof destination === "string" &&
