            ...
            {(() => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <AntdInput
                      className={classNames("__wab_instance", sty.input__fi5N7)}
                    />
                  </FormItemWrapper>
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__ju6R1
                    )}
                    initialValue={"\u9a8c\u8bc1\u7801"}
                    label={"\u9a8c\u8bc1\u7801"}
                    name={"message"}
                  ...
                  >
                    <AntdInput
                      className={classNames("__wab_instance", sty.input__nQjNe)}
                    />
                  </FormItemWrapper>
                  <AntdButton
                    className={classNames("__wab_instance", sty.button__etfk2)}
                    disabled={false}
                    submitsForm={true}
                    type={"primary"}
                  >
