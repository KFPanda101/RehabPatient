            ...
            {(() => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <AntdInput
                      className={classNames("__wab_instance", sty.input__rsP2)}
                    />
                  </FormItemWrapper>
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__uP9GT
                    )}
                    initialValue={"\u9a8c\u8bc1\u7801"}
                    label={"\u9a8c\u8bc1\u7801"}
                    name={"message"}
                  ...
                  >
                    <AntdInput
                      className={classNames("__wab_instance", sty.input__iLxHl)}
                    />
                  </FormItemWrapper>
                  <AntdButton
                    className={classNames("__wab_instance", sty.button__crfjj)}
                    disabled={false}
                    submitsForm={true}
                    type={"primary"}
                  >
